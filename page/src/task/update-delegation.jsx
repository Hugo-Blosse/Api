...
const DelegationUpdate = ({task, username}) => {
    ...
    const handleDelegationUpdate = async() => {
    ...
    return (
        ...
        {showContent &&
          <form onSubmit={handleDelegationUpdate}>
               <Stack>
                    <FormControl required margin="normal">
                       <InputLabel htmlFor="name">Delegation's topic</InputLabel>
                        <OutlinedInput id="name" label="Delegation's topic" value={name} size="small" onChange={e => setName(e.target.value)} />
                    </FormControl>
                    <FormControl required margin="normal">
                    ...
                    <FormControl required margin="normal">
                        <InputLabel htmlFor="date">Delegation date ex. 01-01-2024</InputLabel>
                        <OutlinedInput id="date" label="Delegation's date ex. 01-01-2024" value={date} onChange={e => setDate(e.target.value)} />
                    </FormControl>
                    <FormControl required margin="normal">
                        <InputLabel htmlFor="location">Delegation location</InputLabel>
                        <OutlinedInput id="location" label="Delegation location" value={location} onChange={e => setLocation(e.target.value)} />
                    </FormControl>
